...
<html>
    ...
    <body>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <td><a href="http://localhost:8080/NadjiIgraca/admin/prikaziDodajTip" class="btn btn-primary">Dodaj Tip</a></td>
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <table class="table table-dark" >
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Podloga</th>
                                <th scope="col">Namena</th>
                                <th scope="col">Izmeni Tip</th>
                        ...
                        <c:forEach items="${tip}" var="tip">
                            <tbody>
                                <tr>
                                    <th scope="row"><c:out value="${tip.id}"/></th>
                                    <td><c:out value="${tip.podloga}"/></td>
                                    <td><c:out value="${tip.namena}"/></td>

                                    <td><a href="http://localhost:8080/NadjiIgraca/admin/izmenitip?id=<c:out value='${tip.id}'/>" class="btn btn-primary"/>Izmeni Tip</td>
                                    <td><a href="http://localhost:8080/NadjiIgraca/admin/obrisitip?id=<c:out value='${tip.id}'/>" class="btn btn-primary"/>Obrisi Tip</td>
                                </tr> 
                            </tbody>
                        </c:forEach>
                    </table>
