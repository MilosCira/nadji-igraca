        ...
        <section id="about" class="py-5">
            <div class="container">
                <div class="row text-center">
                    <div class="col-md-12">
                        <h2 class="mb-3 display-4">Pravila sajta</h2>
                        <p>Svako ko na bilo koji način zloupotrebljava sajt, biće sankcionisan brisanjem profila.
                            <br>
                            Zabranjeno je: Lažne ponude, nepristojne slike profila, lažni podaci.</p>
                    </div>
                </div>
            </div>
        </section>  
