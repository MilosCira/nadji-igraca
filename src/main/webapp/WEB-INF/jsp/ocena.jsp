...
<html>
    ...
    <body>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <td><a href="http://localhost:8080/NadjiIgraca/admin/dodajocenu" class="btn btn-primary">Dodaj Ocenu</a></td>
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <table class="table table-dark" >
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Igrac ocenio</th>
                                <th scope="col">Igrac ocenjen</th>
                                <th scope="col">Ocena</th>
                                <th scope="col">Komentar</th>
                                <th scope="col">Izmeni Ocenu</th>
                                <th scope="col">Obrisi Ocenu</th>      
                            </tr>
                        </thead>
                        <c:forEach items="${ocena}" var="ocena">
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row"><c:out value="${ocena.id}"/></th>
                                    <td><c:out value="${ocena.igrIme}"/></td>
                                    <td><c:out value="${ocena.igrKome}"/></td>
                                    <td><c:out value="${ocena.ocena}"/></td>
                                    <td><c:out value="${ocena.komentar}"/></td>
                                    <td><a href="http://localhost:8080/NadjiIgraca/admin/izmeniocenu?id=<c:out value='${ocena.id}'/>" class="btn btn-primary"/>Izmeni Ocenu</td>
                                    <td><a href="http://localhost:8080/NadjiIgraca/admin/obrisiocenu?id=<c:out value='${ocena.id}'/>" class="btn btn-primary"/>Obrisi Ocenu</td>
                                </tr>
