...
<html>
    ...
    <body>
        ...
        <div id="page-wrapper" >
            ...
            <div id="page-inner">
                            <td><a href="http://localhost:8080/NadjiIgraca/admin/prikaziDodajIgraca" class="btn btn-primary">Dodaj Igraca</a></td>
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <table class="table table-dark" >
                        ...
                        <c:forEach items="${igrac}" var="user">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th><c:out value="${user.godine}"/></th>
                                    <td><c:out value="${user.email}"/></td>
                                    <td><c:out value="${user.password}"/></td>
                                    
                                    <td><a href="http://localhost:8080/NadjiIgraca/admin/prikaziizmeniigraca?id=<c:out value='${user.id}'/> "  class="btn btn-primary">Izmeni Igraca</a></td>
                                    <td><a href="http://localhost:8080/NadjiIgraca/admin/obrisiigraca?id=<c:out value='${user.id}'/>" class="btn btn-primary">Obrisi Igraca</a></td>
                                </tr> 
