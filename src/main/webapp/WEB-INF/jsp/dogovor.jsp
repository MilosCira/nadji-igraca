...
<html>
    ...
    <body>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <td><a href="http://localhost:8080/NadjiIgraca/admin/prikazidodajdogovor" class="btn btn-primary"/>Dodaj Dogovor</a></td>
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <table class="table table-dark" >
                        ...
                        <c:forEach items="${dogovor}" var="dogovor">
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row"><c:out value="${dogovor.id}"/></th>
                                    <td><c:out value="${dogovor.lokacija}"/></td>
                                    <td><c:out value="${dogovor.vreme}"/></td>
                                    <td><c:out value="${dogovor.igraci}"/></td>
                                    <td><c:out value="${dogovor.spoIme}"/></td>
                                    <td><c:out value="${dogovor.igrIme}"/></td>
                                    <td><c:out value="${dogovor.igrEmail}"/></td>
                                    <td><a href="http://localhost:8080/NadjiIgraca/admin/izmenidogovore?id=<c:out value='${dogovor.id}'/>" class="btn btn-primary"/>Izmeni Dogovor</td>
                                    <td><a href="http://localhost:8080/NadjiIgraca/admin/obrisidogovor?id=<c:out value='${dogovor.id}'/>" class="btn btn-primary"/>Obrisi Dogovor</td>
                                </tr>
