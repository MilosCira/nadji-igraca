                ...
                <div class="row">
                    ...
                    <div class="container">
                        <div class="panel-body">
                            ...
                            <c:choose>
                                <c:when test="${edit}">
                                    <form id="register-form" action="http://localhost:8080/NadjiIgraca/admin/updateigraca?id=${igrac.id}" method="get" role="form">
                                </c:when>
                                <c:otherwise>
                                    <form id="register-form" action="http://localhost:8080/NadjiIgraca/admin/dodajigraca" method="post" role="form">
                                </c:otherwise>
                            </c:choose>       
                                        <input type="hidden" value="${igrac.id}" name="id">
                                   <div class="form-group">
                                       <input type="text" name="ime" id="ime" tabindex="1" class="form-control" placeholder="Ime" value="${igrac.ime}" required>
                                        </div>
                                        <div class="form-group">                                 
                                            <input type="text" name="prezime" id="prezime" tabindex="1" class="form-control" placeholder="Prezime" value="${igrac.prezime}" required>
                                        </div>
                                        <div class="form-group">                                 
                                            <input type="text" name="email" id="email" tabindex="1" class="form-control" placeholder="Email Address" value="${igrac.email}" required>
                                        </div>

                                        <div class="form-group">
                                            <input type="password" name="password" id="password" tabindex="1" class="form-control" value="${igrac.password}" placeholder="Password" required>
                                        </div>
                                        
                                        <div class="form-group">
                                            <input type="text" name="telefon" id="telefon" tabindex="2" class="form-control" value="${igrac.telefon}" placeholder="Telefon" required> 
                                        </div>
                                        <div class="form-group">
                                            <input type="text" name="godine" id="godine" tabindex="2" class="form-control" value="${igrac.godine}" placeholder="Godine" required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6 col-sm-offset-3">
                                                    <input type="submit" name="register-submit" id="register-submit" tabindex="4" class="form-control btn btn-register" value="Dodaj Igraca">
                                                </div>
                                                </c:if>
                                                <c:if test="${edit}">
                                                    <div class="col-sm-6 col-sm-offset-3">
                                                    <input type="submit" name="register-submit" id="register-submit" tabindex="4" class="form-control btn btn-register" value="Izmeni Igraca">
                                                </div>
                                                </c:if>
                                            </div>
                                        </div>
