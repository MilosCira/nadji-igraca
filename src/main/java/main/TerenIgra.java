...
public class TerenIgra {
    ...
    public TerenIgra(int id, String lokacija,String slika, int tipId, int grdId, String tipIme, String gradIme, String tipPodloga, String spoIme) {
        this.id = id;
