...
<html>
    ...
    <body>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <td><a href="http://localhost:8080/NadjiIgraca/admin/prikazidodajdrzavu" class="btn btn-primary"/>Dodaj Drzavu</a></td>
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <table class="table table-dark" >
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Izmeni Drzavu</th>
                                <th scope="col">Obrisi Drzavu</th>
                            </tr>
                        </thead>
                        <c:forEach items="${drzava}" var="drzava">
                            <tbody>

                                <tr>
                                    <th scope="row"><c:out value="${drzava.id}"/></th>
                                    <td><c:out value="${drzava.ime}"/></td>
                                    <td><a href="http://localhost:8080/NadjiIgraca/admin/izmenidrzave?id=<c:out value='${drzava.id}'/>" class="btn btn-primary"/>Izmeni Drzavu</td>
                                    <td><a href="http://localhost:8080/NadjiIgraca/admin/obrisidrzavu?id=<c:out value='${drzava.id}'/>" class="btn btn-primary"/>Obrisi Drzavu</td>
                                </tr> 
                            </tbody>
                        </c:forEach>
                    </table>
