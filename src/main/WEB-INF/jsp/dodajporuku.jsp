                ...
                <div class="row">
                    ...
                    <div class="container">
                        <div class="panel-body">
                            ...
                            <c:choose>
                                <c:when test="${izmena}">
                                    <form id="register-form" action="http://localhost:8080/NadjiIgraca/admin/updateporuku?id=${poruke.id}" method="post" role="form">
                                    </c:when>
                                    <c:otherwise>
                                        <form id="register-form" action="http://localhost:8080/NadjiIgraca/admin/dodajporuku" method="post" enctype="multipart/form-data">
                                        </c:otherwise>
                                    </c:choose> 
                                    ...
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <label class="input-group-text" for="inputGroupSelect01">Izaberi za koji dogovor zelis da posaljes poruku</label>
                                        </div>
                                        <select name="dogIdPor">
                                            <c:forEach items="${dogovor}" var="dogovor">                        
                                                <option value=<c:out value="${dogovor.id}"/> > <c:out value="${dogovor.lokacija}"/> ${dogovor.igrIme} ${dogovor.igrEmail} </option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                      ...
                                      <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <label class="input-group-text" for="inputGroupSelect01">Izaberi ko salje poruku</label>
                                        </div>
                                        <select name="igrId">
                                            <c:forEach items="${igrac}" var="igrac">                        
                                                <option value=<c:out value="${igrac.id}"/> > <c:out value="${igrac.ime}"/> ${igrac.prezime} ${igrac.email} </option>
                                            </c:forEach>
                                        </select>
                                    </div>      
                                    ...
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <label class="input-group-text" for="inputGroupSelect01">Izaberi kome zelis da posaljes poruku</label>
                                        </div>
                                        <select name="igrIdKome">
                                            <c:forEach items="${igrac}" var="igrac">                        
                                                <option value=<c:out value="${igrac.id}"/> > <c:out value="${igrac.ime}"/> ${igrac.prezime} ${igrac.email} </option>
                                            </c:forEach>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="1" id="poruka" name="poruka" >${poruke.poruka}</textarea>
                                    </div> 
                                        ...
                                        <div class="row">
                                            <c:if test="${izmena==null}">
                                                <div class="col-sm-6 col-sm-offset-3">
                                                    <input type="submit" name="register-submit" id="register-submit" tabindex="4" class="form-control btn btn-register" value="Posalji Poruku">
                                                </div>
                                            </c:if>
                                            <c:if test="${izmena}">
                                                <div class="col-sm-6 col-sm-offset-3">
                                                    <input type="submit" name="register-submit" id="register-submit" tabindex="4" class="form-control btn btn-register" value="Izmeni Poruku">
                                                </div>
                                            </c:if>
                                        </div>
                                    </div>
