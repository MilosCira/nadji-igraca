            ...
            <div class="container">
                <div class="row">  
                       <table class="table table-dark" >
                        <thead>
                        <h2>Aktivne ponude</h2>
                            <tr>
                                <th scope="col">Ime</th>
                                <th scope="col">Prezime</th>                                                              
                                <th scope="col">Lokacija Dogovora</th>
                                <th scope="col">Lokacija Terena</th>
                                <th scope="col">Datum i Vreme</th>
                                <th scope="col">Broj Igrača</th>
                                <th scope="col">Sport</th>
                                <th scope="col">Profil Igrača</th>
                            </tr>
                        ...
                        <c:forEach items="${dogovori}" var="dogovor">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><c:out value="${dogovor.igrPrez}"/></td>                                  
                                    <td><c:out value="${dogovor.lokacija}"/></td>
                                    <td><c:out value="${dogovor.terLokacija}"/></td>
                                    <td><c:out value="${dogovor.tekstVreme}"/></td>
                                    <td><c:out value="${dogovor.igraci}"/></td>
                                    <td><c:out value="${dogovor.spoIme}"/></td>
                                    <td><a href="http://localhost:8080/NadjiIgraca/igrac/<c:out value="${dogovor.igrId}"/>" class="btn btn-primary"/>Prikazi Profil Igrača</td>
                                </tr> 
