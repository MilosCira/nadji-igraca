...
<html>
    ...
    <body>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <td><a href="http://localhost:8080/NadjiIgraca/admin/prikazidodajgrad" class="btn btn-primary">Dodaj Grad</a></td>
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <table class="table table-dark" >
                        ...
                        <tbody>
                            <c:forEach items="${grad}" var="grad">
                                <tr>
                                    <th scope="row"><c:out value="${grad.id}"/></th>
                                    <td><c:out value="${grad.ime}"/></td> 
                                    <td><c:out value="${grad.drzIme}"/></td>
                                    <td><a href="http://localhost:8080/NadjiIgraca/admin/izmenigrad?id=<c:out value='${grad.id}'/>" class="btn btn-primary"/>Izmeni Grad</td>
                                    <td><a href="http://localhost:8080/NadjiIgraca/admin/obrisigrad?id=<c:out value='${grad.id}'/>" class="btn btn-primary"/>Obrisi Grad</td>
                                </tr> 
