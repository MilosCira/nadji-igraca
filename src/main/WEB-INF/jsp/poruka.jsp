...
<html>
    ...
    <body>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="http://localhost:8080/NadjiIgraca/admin/prikaziporuke"><i class="fa fa-edit "></i>Poruke</a>
                    </li>
                </ul>
            </div>
        </nav>
        <div id="page-wrapper" >
            <div id="page-inner">
                <td><a href="http://localhost:8080/NadjiIgraca/admin/dodajporuku" class="btn btn-primary">Dodaj Poruku</a></td>
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <table class="table table-dark" >
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Lokacija Dogovora</th>
                                <th scope="col">Sadrzaj Poruke</th>
                                <th scope="col">Vreme Poruke</th>
                                <th scope="col">Igrac Ime</th>
                                <th scope="col">Igrac Prezime</th>
                                <th scope="col">Izmeni Grad</th>
                                <th scope="col">Obrisi sve</th>
                            </tr>
                        </thead>
                        <tbody>
                            <c:forEach items="${poruke}" var="poruke">
                                <tr>
                                    <th scope="row"><c:out value="${poruke.id}"/></th>
                                    <td><c:out value="${poruke.dogLokacija}"/></td> 
                                    <td><c:out value="${poruke.poruka}"/></td>
                                    <td><c:out value="${poruke.porVreme}"/></td>
                                    <td><c:out value="${poruke.igrImePor}"/></td>
                                    <td><c:out value="${poruke.igrPrezPor}"/></td>
                                    <td><a href="http://localhost:8080/NadjiIgraca/admin/izmeniporuku?id=<c:out value='${poruke.id}'/>" class="btn btn-primary"/>Izmeni Poruku</td>
                                    <td><a href="http://localhost:8080/NadjiIgraca/admin/obrisiporuku?id=<c:out value='${poruke.id}'/>" class="btn btn-primary"/>Obrisi Poruku</td>
                                </tr> 
