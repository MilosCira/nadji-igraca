                ...
                <div class="row">
                    ...
                    <div class="container">
                        <div class="panel-body">
                            <c:choose>
                                <c:when test="${izmena}">
                                    <form id="register-form" action="http://localhost:8080/NadjiIgraca/admin/updatetip?id=${tip.id}" method="post" role="form">
                                    </c:when>
                                    <c:otherwise>    
                                        <form id="register-form" action="http://localhost:8080/NadjiIgraca/admin/dodajtip" method="post" role="form">
                                        </c:otherwise>
                                    </c:choose> 
                                    <div class="form-group">
                                        <input type="text" name="podloga" id="podloga" tabindex="1" class="form-control" placeholder="Podloga" value="${tip.podloga}" required>
                                    </div>
                                    <div class="form-group">                                 
                                        <input type="text" name="namena" id="namena" tabindex="1" class="form-control" placeholder="Namena" value="${tip.namena}" required>
                                    </div>
                                        ...
                                        <div class="row">
                                            <c:if test="${izmena==null}">
                                                <div class="col-sm-6 col-sm-offset-3">
                                                    <input type="submit" name="register-submit" id="register-submit" tabindex="4" class="form-control btn btn-register" value="Dodaj Tip">
                                                </div>
                                            </c:if>
                                            <c:if test="${izmena}">
                                                <div class="col-sm-6 col-sm-offset-3">
                                                    <input type="submit" name="register-submit" id="register-submit" tabindex="4" class="form-control btn btn-register" value="Izmeni Tip">
                                                </div>
                                            </c:if>
                                        </div>
                                    </div>
